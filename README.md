...
Machine-Learning-Group-Project - Mental Ilness prediction
...
This project applies machine learning to the 2019 Patient Characteristics Survey dataset to predict mental illness and substance use disorders. It covers data preprocessing, exploratory analysis, model training (Logistic Regression, Decision Tree, Random Forest), and evaluation. An interactive Streamlit app is included to demonstrate the prediction
...
-->  Key Variables Sociodemographic data: Age Group, Sex, Transgender, Sexual Orientation, Hispanic Ethnicity, Race, Living Situation, Household Composition, Education Status, Employment Status Mental health and developmental disorders: Mental Illness, Serious Mental Illness, Intellectual Disability, Autism Spectrum, Other Developmental Disability Substance use disorders: Alcohol Related Disorder, Drug Substance Disorder, Opioid Related Disorder Chronic medical conditions: Diabetes, Obesity, Stroke, Cancer, Hyperlipidemia, High Blood Pressure, Heart Attack, Pulmonary Asthma Lifestyle and habits: Cannabis Recreational Use, Smokes, Received Smoking Counseling Social and insurance coverage: Medicaid Insurance, Medicare Insurance, Private Insurance, Public Assistance Cash Program
-->  Target: Predict presence/absence of mental illness
Source: NYS OMH PCS 2019 (Patient Characteristics Survey) Files included:
...
3 . Technologies Used Programming Language:--

Python 3.x Data Analysis & ML: pandas, NumPy, scikit-learn, imbalanced-learn (SMOTE) Ml model : Logistic Regression, Random Forest, Decision Tree Visualization: Matplotlib, Seaborn Model Deployment: Streamlit Environment: Jupyter Notebook, GitHub Version Control: Git
Authors
1. Arjun Chintham – MSc Data Science & AI - DSTI School of engineering – GitHub
2. Lyna Mouhoubi– MSc Data Engineering - DSTI School of engineering – GitHub
3. Nirusa Jegaseelan – MSc Data Analytics - DSTI School of engineering – GitHub
4. Amina Rabehi – MSc Data Analytics - DSTI School of engineering – GitHub
...
git clone https://github.com/aarjunvarma/Machine-Learning-Group-Project.git cd Machine-Learning-Group-Project
...
cd "Web App" streamlit run webapp_file_copy.py
=======
# Machine-Learning-Group-Project
Analysis of NYS Office of Mental Health’s 2019 Patient Characteristics Survey (PCS)—a one-week snapshot from \~4,000 programs and \~196k clients. This repo cleans, explores, and models the data to surface insights on community-based, recovery-oriented mental health services.
>>>>>>> 899a3b18c0b36124052e03e4852a85e993b32364
